      ...
      <div className="landing-content">
        ...
        <div className="journey-selector">
          ...
          >
            ...
            <option value="mfa_optional">Email/Password Self-registration - 2SV optional</option>
            <option value="mfa_mandatory">Email/Password Self-registration - 2SV mandatory</option>
